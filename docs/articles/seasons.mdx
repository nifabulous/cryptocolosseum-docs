...
A Season of the Crypto Colosseum is 8 weeks long.
...
|---    |---    |
| 100,000 PTG   | Finals winning gladiator’s contract holder |
| 20,000 PTG    | Each contract holder of the other gladiators(3) in the finals from the winning Ludus |
| 100,000 PTG   | Split evenly among all gladiator contract holders in the winning Ludus (per gladiator) |
| | Runner up Ludus |
| 10,000 PTG    | Each contract holder  of gladiators in the finals for the runner up Ludus (4)|
| 50,000 PTG    | Split evenly among all gladiator contract holders in the runner up Ludus (per gladiator) |

There is a trade deadline which happens five weeks into the season.
...
|  |  |
|---    |---    |
| SEASON THREE    | RATTLEDANCE OF THE DAMNED |
| DATES | FEBRUARY 7 2022 - APRIL 3 2022 |
| TRADE DEADLINE | MARCH 13 2022 |
| LUDUS CHAMPION    | LEGION OF DOOM |
| PROMOTED GLADIATORS   | Grendel Grinder, Nefertiti Nakamoto, Talon  |
| RELEGATED GLADIATORS  | Elon, Spartacus and Spoticus  |


** CRPYTO COLOSSEUM SEASON IV: **

|  |  |
|---    |---    |
| SEASON FOUR    | SEASON NOT TO BE NAMED |
| DATES | APRIL 25 2022 - JUL 10 2022 |
| TRADE DEADLINE |  MAY 29, 2022 |
| LUDUS CHAMPION    | THE KINGMAKERS  |
| PROMOTED GLADIATORS   | IMPERATOR KRAV LAGRAV, OCTOGO YEARN, JOHN THE BEAST |
| RELEGATED GLADIATORS  | GOERLI, TROY HARD, TALON  |



** CRPYTO COLOSSEUM SEASON V: **

|  |  |
|---    |---    |
| SEASON FOUR    | -----|
| DATES | AUGUST 01 2022 - SEPTEMBER 25 2022 |
| TRADE DEADLINE |  AUGUST 28, 2022 |
| LUDUS CHAMPION    | --  |
| PROMOTED GLADIATORS   | -- |
